...
class Awvisualmerchandising extends Module
{
    ...
    public $tabs = [
        [
            ...
            'class_name' => 'AdminAwvisualmerchandising',
    ...
    public function __construct()
    {
        ...
        $this->description = $this->l('Visual Merchandising Tool');
   ...
   public function hookDisplayBackOfficeHeader()
{
    ...
    if ($controller === 'AdminAwvisualmerchandising') {
        Media::addJsDef([
            'token' => Tools::getAdminTokenLite('AdminAwvisualmerchandising'),
        ]);
