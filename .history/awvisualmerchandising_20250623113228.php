...
class Awvisualmerchandising extends Module
{
    public $tabs = [
        [
            'name' => 'Visual Merchandising', // ✅ fallback name
            'class_name' => 'AdminAwvisualmerchandising',
            'parent_class_name' => 'ShopParameters',
            'visible' => true,
            'wording' => 'Visual Merchandising',               // 🗝️ Translation key
            'wording_domain' => 'Modules.Awvisualmerchandising.Admin', // 🌐 Translation domain
        ],
    ];
    ...
    public function uninstall()
    {
        ...
        $id_tab = (int) Db::getInstance()->getValue('SELECT id_tab FROM ' . _DB_PREFIX_ . 'tab WHERE class_name = "AdminAwvisualmerchandising"');
        if ($id_tab) {
            $tab = new Tab($id_tab);
            $tab->delete();
        }
