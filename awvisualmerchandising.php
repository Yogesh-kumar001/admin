...
public function install()
{
    ...
    return parent::install()
        ...
        && $this->registerTab(); // call tab registration at the end
}


private function uninstallTab()
{
    $tabId = (int) Tab::getIdFromClassName('AdminMerchandising');
    if ($tabId) {
        $tab = new Tab($tabId);
        return $tab->delete();
    }
   ...
   private function registerTab()
{
    ...
    $tab->id_parent = (int) Tab::getIdFromClassName('AdminCatalog'); // you can change this to another parent if needed
